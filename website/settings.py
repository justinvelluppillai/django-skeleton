...
ADMINS = (
    ('Justin Velluppillai', 'justinvelluppillai@gmail.com'),
)
...
# See https://docs.djangoproject.com/en/1.5/ref/setting/#allowed-hosts
ALLOWED_HOSTS = []
...
SECRET_KEY = '(@8=l+fc!wkt+!+!g#b_-@l&abv^!z#qf2ky(z+utf*6mkmuyi'
